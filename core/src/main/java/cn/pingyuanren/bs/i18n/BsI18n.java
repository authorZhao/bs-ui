 ...
 */
package cn.pingyuanren.bs.i18n;
 ...
 *
 * <h3>语言文件</h3>
 * <p>classpath {@code cn/pingyuanren/bs/i18n/{locale}.properties}，扁平 key-value：
 * <pre>{@code
 * btn.ok=确定
...
public final class BsI18n {
    ...
    private static final String CORE_BUNDLE = "cn/pingyuanren/bs/i18n/";
    /** 默认语言。 */
     ...
     *
     * @param classpathDir classpath 目录路径，如 {@code "cn/pingyuanren/bs/demo/i18n/"}，
