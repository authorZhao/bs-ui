...
public final class BsIcon {
    ...
    public static final String DEFAULT_ATLAS_PATH = "cn/pingyuanren/bs/ui/icons/bootstrap-icons.atlas";
    ...
    /**
     * 加载指定 atlas。
     * @param atlasPath assets 内相对路径（如 "cn/pingyuanren/bs/ui/icons/bootstrap-icons.atlas"）
