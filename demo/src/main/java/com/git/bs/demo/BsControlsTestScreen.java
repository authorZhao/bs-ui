...
public class BsControlsTestScreen extends ScreenAdapter {
    ...
    private static com.badlogic.gdx.utils.Array<String> items(java.util.List<String> in) {
    ...
    private void switchModule(int index) {
        ...
        switch (index) {
            ...
            case 44: fillWave4Pickers(content); break;
            case 45: fillWave4Display(content); break;
            case 46: fillWave4Form(content); break;
            case 47: fillWave4Data(content); break;
            default:
    ...
    private void fillPickers(Table c) {
        ...
        colorPicker.setSelectedColor(com.badlogic.gdx.graphics.Color.valueOf("#0D6EFD"));
        ...
        colorPicker2.setSelectedColor(com.badlogic.gdx.graphics.Color.valueOf("#DC3545"));
    ...
    private void fillTable(Table c) {
        ...
        // 准备 25 行假数据（分 3 页）
        java.util.List<String> headers = java.util.Arrays.asList("ID", "姓名", "年龄", "状态");
    ...
    private void fillOverlay(Table c) {
        ...
        link2.setColor(com.badlogic.gdx.graphics.Color.valueOf("#198754")); // success 绿
        ...
        link3.setColor(com.badlogic.gdx.graphics.Color.valueOf("#DC3545")); // danger 红
    ...
    private void fillModal(Table c) {
        ...
        withIcon.addListener(new ClickListener() {
            @Override public void clicked(InputEvent event, float x, float y) {
                ...
                new BsModal("操作确认", skin)
                        .setTitleIcon(skin.newDrawable("white", com.badlogic.gdx.graphics.Color.valueOf("#0D6EFD")))
                        .content(content)
                        .contentWidth(360)
                        .separator(true)
                        .addButton("关闭", () -> {}, BsButton.Variant.SECONDARY, BsButton.Style.OUTLINE)
        ...
        withBanner.addListener(new ClickListener() {
            @Override public void clicked(InputEvent event, float x, float y) {
                // 用素材图作 banner
                com.badlogic.gdx.scenes.scene2d.utils.Drawable banner;
                try {
                    banner = BsModal.drawableFromPath("bs/test/img/20251110013443.png");
                } catch (Throwable t) {
                    banner = skin.newDrawable("white", com.badlogic.gdx.graphics.Color.valueOf("#FD7E14"));
                }
    ...
    private void fillCards(Table c) {
        ...
        try {
            com.badlogic.gdx.scenes.scene2d.utils.Drawable img1 =
                    com.git.bs.ui.BsModal.drawableFromPath("bs/test/img/20251110013443.png");
        ...
        try {
            com.badlogic.gdx.scenes.scene2d.utils.Drawable img2 =
                    com.git.bs.ui.BsModal.drawableFromPath("bs/test/img/20251109230728.png");
    ...
    private void fillProfile(Table c) {
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable avatar = null;
        try {
            avatar = com.git.bs.ui.BsModal.drawableFromPath("bs/test/img/20251121200555.png");
        } catch (Throwable t) {
    ...
    private void fillIcons(Table c) {
        ...
        iconFilterField.addListener(new com.badlogic.gdx.scenes.scene2d.InputListener() {
            @Override public boolean keyTyped(com.badlogic.gdx.scenes.scene2d.InputEvent event, char character) {
                refreshIconGrid();
                return false;
            }
            @Override public boolean keyUp(com.badlogic.gdx.scenes.scene2d.InputEvent event, int keycode) {
                refreshIconGrid();
                return false;
            }
        });
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable gearIcon = com.git.bs.ui.BsIcon.get("gear");
        if (gearIcon != null) settingBtn.setIcon(gearIcon);
        settingBtn.addListener(new com.badlogic.gdx.scenes.scene2d.utils.ClickListener() {
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable personIcon = com.git.bs.ui.BsIcon.get("person");
        if (personIcon != null) userBtn.setIcon(personIcon);
        userBtn.addListener(new com.badlogic.gdx.scenes.scene2d.utils.ClickListener() {
            @Override public void clicked(com.badlogic.gdx.scenes.scene2d.InputEvent event, float x, float y) {
                setStatus("点了 [用户] 按钮");
            }
        });
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable trashIcon = com.git.bs.ui.BsIcon.get("trash");
        if (trashIcon != null) delBtn.setIcon(trashIcon);
        delBtn.addListener(new com.badlogic.gdx.scenes.scene2d.utils.ClickListener() {
            @Override public void clicked(com.badlogic.gdx.scenes.scene2d.InputEvent event, float x, float y) {
                setStatus("点了 [删除] 按钮");
            }
        });
        ...
        com.git.bs.ui.BsLink inboxLink = new com.git.bs.ui.BsLink("收件箱", skin);
        com.badlogic.gdx.scenes.scene2d.utils.Drawable envelopeIcon = com.git.bs.ui.BsIcon.get("envelope");
        if (envelopeIcon != null) inboxLink.setIcon(envelopeIcon);
        inboxLink.addListener(new com.badlogic.gdx.scenes.scene2d.utils.ClickListener() {
            @Override public void clicked(com.badlogic.gdx.scenes.scene2d.InputEvent event, float x, float y) {
                setStatus("点了 [收件箱] 链接");
            }
        });
        ...
        com.git.bs.ui.BsLink homeLink = new com.git.bs.ui.BsLink("首页", skin);
        com.badlogic.gdx.scenes.scene2d.utils.Drawable homeIcon = com.git.bs.ui.BsIcon.get("house");
        if (homeIcon != null) homeLink.setIcon(homeIcon);
        demoRow2.add(homeLink);

        // IconLabel
        com.badlogic.gdx.scenes.scene2d.utils.Drawable heartIcon = com.git.bs.ui.BsIcon.get("heart");
        if (heartIcon != null) {
            com.git.bs.ui.BsIconLabel il1 = new com.git.bs.ui.BsIconLabel("点赞", skin)
                    .icon(heartIcon)
                    .iconColor(com.badlogic.gdx.graphics.Color.valueOf("#DC3545"));
            demoRow2.add(il1);
        }
        com.badlogic.gdx.scenes.scene2d.utils.Drawable starIcon = com.git.bs.ui.BsIcon.get("star-fill");
        if (starIcon != null) {
            com.git.bs.ui.BsIconLabel il2 = new com.git.bs.ui.BsIconLabel("收藏", skin)
                    .icon(starIcon)
                    .iconColor(com.badlogic.gdx.graphics.Color.valueOf("#FFC107"));
            demoRow2.add(il2);
        }
        ...
        com.git.bs.ui.BsMenuBar iconBar = new com.git.bs.ui.BsMenuBar(skin);
        com.git.bs.ui.BsMenuBar.BsMenu fileMenu = iconBar.addMenu("文件",
        ...
        com.git.bs.ui.BsMenuBar.BsMenu editMenu = iconBar.addMenu("编辑",
    ...
    private void refreshIconGrid() {
        ...
        java.util.List<String> names = new java.util.ArrayList<>(com.git.bs.ui.BsIcon.getAllNames());
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable cellBg =
                skin.newDrawable("white", new com.badlogic.gdx.graphics.Color(
                        0x2C / 255f, 0x3E / 255f, 0x50 / 255f, 1f));
        for (String name : filtered) {
            com.badlogic.gdx.scenes.scene2d.utils.Drawable d = com.git.bs.ui.BsIcon.get(name);
            if (d == null) continue;
            ...
            com.badlogic.gdx.scenes.scene2d.ui.Label lab = new com.badlogic.gdx.scenes.scene2d.ui.Label(name, skin);
            lab.setFontScale(0.7f);
            lab.setColor(com.badlogic.gdx.graphics.Color.LIGHT_GRAY);
            cell.add(lab);
        ...
        if (truncated) {
            iconGrid.row();
            com.badlogic.gdx.scenes.scene2d.ui.Label more = new com.badlogic.gdx.scenes.scene2d.ui.Label(
                    "(只显示前 " + maxShow + " 个，更精确过滤查看更多)", skin);
            more.setColor(com.badlogic.gdx.graphics.Color.GRAY);
            iconGrid.add(more).colspan(cols).padTop(8).row();
        }
        if (filtered.isEmpty()) {
            iconGrid.add(new com.badlogic.gdx.scenes.scene2d.ui.Label(
    ...
    private void fillInputNumberGroup(Table c) {
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable envelope =
    ...
    private void fillNavbarOffcanvas(Table c) {
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable logoIcon = com.git.bs.ui.BsIcon.get("house");
    ...
    private void fillChartsLine(Table c) {
        ...
        java.util.List<BsChart.Series> lineSeries2 = new java.util.ArrayList<>();
    ...
    private <T extends com.badlogic.gdx.scenes.scene2d.Actor> com.badlogic.gdx.scenes.scene2d.ui.Container<T> wrapChart(
            T chart, float w, float h) {
        com.badlogic.gdx.scenes.scene2d.ui.Container<T> wrap = new com.badlogic.gdx.scenes.scene2d.ui.Container<>(chart);
        wrap.fill();
        wrap.size(w, h);
        return wrap;
    }
    ...
    private void fillP2Content(Table c) {
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable envelope =
                com.git.bs.ui.BsIcon.get("envelope");
        com.badlogic.gdx.scenes.scene2d.utils.Drawable gear =
    ...
    private void fillP2Carousel(Table c) {
        ...
        c.add(new com.badlogic.gdx.scenes.scene2d.ui.Container<BsCarousel>() {{
            setActor(carousel);
            fill();
        ...
        try {
            com.badlogic.gdx.scenes.scene2d.utils.Drawable d1 =
                    com.git.bs.ui.BsModal.drawableFromPath("bs/test/img/20251110013443.png");
            com.badlogic.gdx.scenes.scene2d.utils.Drawable d2 =
                    com.git.bs.ui.BsModal.drawableFromPath("bs/test/img/20251109230728.png");
    ...
    private com.badlogic.gdx.scenes.scene2d.Actor makeColorSlide(String title, String subtitle, Color bg) {
    ...
    /** 生成一个图片 slide（图 + 角标）。 */
    private com.badlogic.gdx.scenes.scene2d.Actor makeImageSlide(
        ...
        com.badlogic.gdx.scenes.scene2d.ui.Container<Label> tagWrap = new com.badlogic.gdx.scenes.scene2d.ui.Container<>(tagLabel);
    ...
    private void fillWave1Basics(Table c) {
        ...
        com.badlogic.gdx.scenes.scene2d.utils.Drawable avatarImg = null;
        try {
            avatarImg = com.git.bs.ui.BsModal.drawableFromPath("bs/test/img/20251121200555.png");
            ...
            @Override public void clicked(InputEvent event, float x, float y) {
                ...
                Thread t = new Thread(() -> {
                    for (int i = 1; i <= 10; i++) {
                        ...
                        final float p = i / 10f;
                        com.badlogic.gdx.Gdx.app.postRunnable(() -> overlay.setProgress(p));
                    }
                    try { Thread.sleep(300); } catch (InterruptedException ignored) {}
                    com.badlogic.gdx.Gdx.app.postRunnable(overlay::close);
                });
                t.setDaemon(true);
                t.start();
            }
    ...
    private void fillWave2Data(Table c) {
        ...
        sheet.addSection("外观");
        sheet.addProperty("accent", com.badlogic.gdx.graphics.Color.valueOf("#0D6EFD"),
                BsPropertySheet.Type.COLOR);
        sheet.addProperty("bg", com.badlogic.gdx.graphics.Color.valueOf("#F8F9FA"),
                BsPropertySheet.Type.COLOR);
        ...
        java.util.List<java.util.List<String>> dt2Rows = new java.util.ArrayList<>();
        for (int i = 0; i < 12; i++) {
    ...
    private void fillWave2Business(Table c) {
        ...
        tb.addSeparator();
        com.badlogic.gdx.scenes.scene2d.utils.Drawable trash =
    ...
    private void fillWave3EditorPro(Table c) {
        ...
        insp.sheet().addProperty("accent", com.badlogic.gdx.graphics.Color.valueOf("#0D6EFD"),
                BsPropertySheet.Type.COLOR);
        ...
        java.util.List<BsMiniMap.Node> nodes = new java.util.ArrayList<>();
        ...
        mm.setNodes(nodes);
        java.util.List<float[]> conns = new java.util.ArrayList<>();
        ...
        c.add(new com.badlogic.gdx.scenes.scene2d.ui.Container<BsMiniMap>() {{
            setActor(mm);
            fill();
    ...
    private void fillWave4Display(Table c) {
        ...
        c.add(new Label("② BsComment 评论 / 聊天气泡（对方/自己/评论流）：",
                skin)).padTop(14).left().row();
        com.badlogic.gdx.scenes.scene2d.utils.Drawable avatar =
                skin.newDrawable("white", com.git.bs.ui.BsPalette.PRIMARY.getMain());
        ...
        for (BsCircularProgress.Variant v : BsCircularProgress.Variant.values()) {
            BsCircularProgress ring = new BsCircularProgress(skin, v)
                    ...
                    .setShowLabel(true);
            ring.setSize(72, 72);
            com.badlogic.gdx.scenes.scene2d.ui.Container<BsCircularProgress> wrap =
                    new com.badlogic.gdx.scenes.scene2d.ui.Container<>(ring);
            wrap.size(72);
            ringRow.add(wrap);
        }
        // 不确定态加载环
        ...
        indet.setSize(48, 48);
        com.badlogic.gdx.scenes.scene2d.ui.Container<BsCircularProgress> indetWrap =
                new com.badlogic.gdx.scenes.scene2d.ui.Container<>(indet);
        indetWrap.size(48);
        ...
        rs.setSize(420, 24);
        com.badlogic.gdx.scenes.scene2d.ui.Container<BsRangeSlider> rsWrap =
                new com.badlogic.gdx.scenes.scene2d.ui.Container<>(rs);
        rsWrap.size(420, 24);
    ...
    private void fillWave4Form(Table c) {
        ...
        errLabel.setColor(com.git.bs.ui.BsPalette.DANGER.getMain());
    ...
    private void fillWave4Data(Table c) {
        ...
        cardLbl.setColor(com.git.bs.ui.BsPalette.PRIMARY.getMain());
        ...
        binLbl.setColor(com.git.bs.ui.BsPalette.DANGER.getMain());
        bin.add(binLbl).pad(6);

        com.badlogic.gdx.scenes.scene2d.ui.Container<Table> cardWrap =
                new com.badlogic.gdx.scenes.scene2d.ui.Container<>(card);
        cardWrap.size(120, 50);
        com.badlogic.gdx.scenes.scene2d.ui.Container<Table> binWrap =
                new com.badlogic.gdx.scenes.scene2d.ui.Container<>(bin);
        binWrap.size(160, 60);
