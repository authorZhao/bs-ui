...
import cn.pingyuanren.bs.ui.BsAccordion;
import cn.pingyuanren.bs.ui.BsAlert;
import cn.pingyuanren.bs.ui.BsButton;
import cn.pingyuanren.bs.ui.BsChoiceDialog;
import cn.pingyuanren.bs.ui.BsCollapse;
import cn.pingyuanren.bs.ui.BsConfirmDialog;
import cn.pingyuanren.bs.ui.BsForm;
import cn.pingyuanren.bs.ui.BsInputNumber;
import cn.pingyuanren.bs.ui.BsInputGroup;
import cn.pingyuanren.bs.ui.BsLink;
import cn.pingyuanren.bs.ui.BsModal;
import cn.pingyuanren.bs.ui.BsPopover;
import cn.pingyuanren.bs.ui.BsPromptDialog;
import cn.pingyuanren.bs.ui.BsSkinFactory;
import cn.pingyuanren.bs.ui.BsSpinner;
import cn.pingyuanren.bs.ui.BsColorPicker;
import cn.pingyuanren.bs.ui.BsDatePicker;
...
public class BsFormModules {
        ...
        withIcon.addListener(new ClickListener() {
            @Override public void clicked(InputEvent event, float x, float y) {
                ...
                new BsModal("操作确认", skin)
                        .setTitleIcon(cn.pingyuanren.bs.ui.BsIcon.get("info-circle-fill", Color.valueOf("#0D6EFD")))
                        .content(content)
                        .contentWidth(360)
                        .separator(true)
    ...
    public void fillDialogs(Table c) {
        ...
        BsButton bNotice = alertBtn(skin, stage, setStatus, "通知 (淡入)",
                cn.pingyuanren.bs.ui.BsAlertDialog.Level.NOTICE, "新消息", "您收到 1 条新消息，请注意查收。");
        BsButton bWarn = alertBtn(skin, stage, setStatus, "警告 (顶部滑入)",
                cn.pingyuanren.bs.ui.BsAlertDialog.Level.WARNING, "操作不可逆", "此操作将永久删除数据，是否继续？");
        BsButton bError = alertBtn(skin, stage, setStatus, "错误 (缩放)",
                cn.pingyuanren.bs.ui.BsAlertDialog.Level.ERROR, "提交失败", "网络异常，请稍后重试。错误码 500。");
        BsButton bSuccess = alertBtn(skin, stage, setStatus, "成功 (淡入)",
                cn.pingyuanren.bs.ui.BsAlertDialog.Level.SUCCESS, "保存成功", "您的修改已成功保存到服务器。");
        ...
        bAutoClose.addListener(new ClickListener() {
            @Override public void clicked(InputEvent event, float x, float y) {
                cn.pingyuanren.bs.ui.BsAlertDialog d = new cn.pingyuanren.bs.ui.BsAlertDialog(
                        "自动关闭", "这条消息 2 秒后自动消失，无需手动关闭。",
                        cn.pingyuanren.bs.ui.BsAlertDialog.Level.NOTICE, skin);
        ...
        bConfirmNoIcon.addListener(new ClickListener() {
            @Override public void clicked(InputEvent event, float x, float y) {
                cn.pingyuanren.bs.ui.BsConfirmDialog d = new cn.pingyuanren.bs.ui.BsConfirmDialog(
