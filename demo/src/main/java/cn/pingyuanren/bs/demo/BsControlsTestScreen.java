...
package cn.pingyuanren.bs.demo;
...
import cn.pingyuanren.bs.demo.modules.BsBasicModules;
import cn.pingyuanren.bs.demo.modules.BsChartModules;
import cn.pingyuanren.bs.demo.modules.BsDataModules;
import cn.pingyuanren.bs.demo.modules.BsFeedbackModules;
import cn.pingyuanren.bs.demo.modules.BsFormModules;
import cn.pingyuanren.bs.demo.modules.BsWaveModules;
...
import cn.pingyuanren.bs.ui.BsSkinExporter;
 ...
 * {@link cn.pingyuanren.bs.demo.modules} 下的 6 个 module 类。</p>
 * @author authorZhao
 * @since 2026-07-16
 */
@Slf4j
public class BsControlsTestScreen extends ScreenAdapter {
    ...
    private void buildLayout() {
        ...
        nav = new BsList<>(skin);
        nav.setItems(cn.pingyuanren.bs.demo.modules.ModuleSupport.items(MODULES));
     ...
     * @param charsCp     字符集文件 classpath 路径（如 cn/pingyuanren/bs/ui/skin/chinese.txt）
