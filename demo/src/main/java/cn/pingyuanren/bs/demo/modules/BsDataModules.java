...
import cn.pingyuanren.bs.ui.BsBadge;
import cn.pingyuanren.bs.ui.BsBadgeButton;
...
import cn.pingyuanren.bs.ui.BsNavbar;
import cn.pingyuanren.bs.ui.BsOffcanvas;
import cn.pingyuanren.bs.ui.BsPagination;
import cn.pingyuanren.bs.ui.BsProfileCard;
import cn.pingyuanren.bs.ui.BsProfilePanel;
import cn.pingyuanren.bs.ui.BsScrollPane;
import cn.pingyuanren.bs.ui.BsTable;
import cn.pingyuanren.bs.ui.BsTree;
...
public class BsDataModules {
    ...
    public void fillCards(Table c) {
        ...
        try {
            ...
            cn.pingyuanren.bs.ui.BsCard card1 = new cn.pingyuanren.bs.ui.BsCard(skin)
                    .image(img1)
                    .imageSize(0, 130)
                    .title("项目卡片")
        ...
        try {
            ...
            cn.pingyuanren.bs.ui.BsCard card2 = new cn.pingyuanren.bs.ui.BsCard(skin)
                    .orientation(cn.pingyuanren.bs.ui.BsCard.Orientation.HORIZONTAL)
                    .image(img2)
                    .imageSize(120, 100)
                    .title("通知中心")
                    .body("您有 3 条未读消息。")
        ...
        cn.pingyuanren.bs.ui.BsCard card3 = new cn.pingyuanren.bs.ui.BsCard(skin)
                .title("关于 Bs UI 框架")
