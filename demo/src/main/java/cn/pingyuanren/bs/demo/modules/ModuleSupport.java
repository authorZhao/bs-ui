...
public final class ModuleSupport {
    ...
    public static BsButton alertBtn(Skin skin, com.badlogic.gdx.scenes.scene2d.Stage stage,
                                     Consumer<String> setStatus, String label,
                                     cn.pingyuanren.bs.ui.BsAlertDialog.Level level, String msg) {
    ...
    public static BsButton alertBtn(Skin skin, com.badlogic.gdx.scenes.scene2d.Stage stage,
                                     Consumer<String> setStatus, String label,
                                     cn.pingyuanren.bs.ui.BsAlertDialog.Level level, String title, String msg) {
        BsButton.Variant v = cn.pingyuanren.bs.ui.BsAlertDialog.levelButtonVariant(level);
        BsButton b = new BsButton(label, skin, v, BsButton.Style.SOLID, BsButton.Size.SM);
        b.addListener(new ClickListener() {
            @Override public void clicked(InputEvent event, float x, float y) {
                cn.pingyuanren.bs.ui.BsAlertDialog.show(stage, skin, level, title, msg);
