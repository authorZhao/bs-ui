...
import cn.pingyuanren.bs.ui.BsSkinLoader;
    ...
    public synchronized void applyTheme(BsTheme theme) {
        ...
        Gdx.app.postRunnable(() -> {
            try {
                ...
                com.badlogic.gdx.Screen next = cn.pingyuanren.bs.admin.AdminContext.get().isLogged()
                        ? new cn.pingyuanren.bs.admin.BsAdminShell(this)
