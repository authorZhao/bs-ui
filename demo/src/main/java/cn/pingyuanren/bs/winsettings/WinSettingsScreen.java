...
public class WinSettingsScreen implements Screen, Router {
    ...
    private Actor buildNav() {
        ...
        Drawable avD = cn.pingyuanren.bs.ui.BsEmoji.randomHead();
        Image avatar;
        if (avD != null) {
            ...
            Drawable fallback = skin.has("bs-circle", Drawable.class)
                    ...
                    : cn.pingyuanren.bs.ui.BsSkinFactory.drawableOf(BsTheme.colorOf("primary"));
    ...
    private class NavItem extends BsButton {
        ...
        NavItem(Skin skin, String key, String iconSym, String text, Runnable onClick) {
            ...
            com.badlogic.gdx.scenes.scene2d.utils.Drawable emojiD =
                    cn.pingyuanren.bs.ui.BsEmoji.isLoaded() ? cn.pingyuanren.bs.ui.BsEmoji.get(iconSym) : null;
            if (emojiD != null) {
                setIcon(emojiD);
            } else {
