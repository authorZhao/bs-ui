...
public class HomePage extends SettingsPage {
    ...
    private void showRenameDialog() {
        ...
        final cn.pingyuanren.bs.ui.BsTextField nameField = new cn.pingyuanren.bs.ui.BsTextField(deviceName, skin);
        ...
        final cn.pingyuanren.bs.ui.BsModal modal = new cn.pingyuanren.bs.ui.BsModal(BsI18n.get("home.rename"), skin);
    ...
    private Actor buildUserCard() {
        ...
        lock.setBackground(cn.pingyuanren.bs.ui.BsSkinFactory.drawableOf(BsTheme.tm()));
    ...
    private Actor buildPersonalizationCard(Router router) {
        ...
        for (int i = 0; i < cs.length; i++) {
            ...
            thumb.setBackground(cn.pingyuanren.bs.ui.BsSkinFactory.drawableOf(cs[i]));
