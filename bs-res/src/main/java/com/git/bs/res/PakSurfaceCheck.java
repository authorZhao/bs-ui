...
public final class PakSurfaceCheck {
    ...
    public static void main(String[] args) {
        ...
        check("com/git/bs/ui/skin/bs-dark.atlas".equals(atlas.path()),
        ...
        check("com/git/bs/ui/skin/bs-dark.png".equals(png.path()), "png 路径 = " + png.path());
        check(png.readBytes().length == 3, "png readBytes().length == 3");

        // 3. child / parent 算术
        check("com/git/bs/ui/skin".equals(json.parent().path()),
                "parent() = " + json.parent().path());
        check("com/git/bs/ui/skin/bs-dark.json/sub.txt".equals(json.child("sub.txt").path()),
        ...
        check("com/git/bs/ui/skin/NOT_EXIST.txt".equals(stub.lastInternal),
